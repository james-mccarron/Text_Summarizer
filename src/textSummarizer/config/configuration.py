...
class ConfigurationManager:
    def __init__(self, config_filepath = CONFIG_FILE_PATH, params_file_path = PARAMS_FILE_PATH):
         ...
         create_directories([self.config[DATA_DIR], self.config[MODEL_DIR], self.config[lf.config.artifacts_root]])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
         config = self.config.get_model_trainer_configparams = self.params.TrainingArguments
         ...
         model_trainer_config = ModelTrainerConfig(
              ...
              num_train_epochs=params.nums_train_epochs,
              warmup_steps=param.num_train_steps,
